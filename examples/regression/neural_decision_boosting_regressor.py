...
from crank_ml.tree.neural_decision_boosting_regressor import NeuralDecisionForestRegressor
from crank_ml.tree.neural_decision_tree_regressor import NeuralDecisionTreeRegressor


class NDTreeBoostingRegressor(pl.LightningModule):
    def __init__(self):
        super().__init__()
        self.model = NeuralDecisionForestRegressor(4, 100)
